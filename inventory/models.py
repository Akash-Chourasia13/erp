...
class SellerInventory(models.Model):
    ...
    model_name = models.ForeignKey(ProductModel,on_delete=models.CASCADE,related_name='sellerModelName')
...
class BuyerInventory(models.Model):
    ...
    model_name = models.ForeignKey(ProductModel,on_delete=models.CASCADE,related_name='buyerModelName')
...
class Inventory(models.Model):
    ...
    model_name = models.ForeignKey(ProductModel,on_delete=models.CASCADE,related_name='inventoryModelName')
